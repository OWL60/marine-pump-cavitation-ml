...
cmd args: [sys.executable, '-m', 'pytest',
           '/tests', 'v', '--tb=short', '--disable-warnings', f'--rootdir={project_root}',
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Test runner for marine-pump-cavitation-ML"
    )
    ...
    parser.add_argument(
        ...
        action="store",
        type=str,
        help="Run test for this particular function",
    )
    parser.add_argument(
        "--data", action="store_true", help="Run test for vibration data generator"
    )
    parser.add_argument(
        "--features", action="store_true", help="Run test for features extraction"
    )
